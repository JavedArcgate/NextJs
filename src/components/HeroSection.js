      ...
      <Row className="w-100 mt-4 topContent">
        <Col xs={12} lg={6}>
          <div className="pe-lg-3">
            <Link href="todays_special">Todays Special </Link>
            ...
            <h3 className="px-lg-5 pt-3 text-muted">
              Our job is delivering a delicious food with fast, free delivery
              and easy. <br></br>
            </h3>
            ...
            <div className="px-lg-5 pt-4">
              ...
              <Button variant="outline-brand rounded-pill px-4 mx-lg-3 mx-md-3 fw-bold" >
                <FaRegPlayCircle className="color-brand" /> How to Order
              </Button>
